  ...
  return (
    <div className="page-container">
      ...
      <form onSubmit={handleAdd} style={{ marginTop: '0.5rem' }}>
        ...
        {repeatEnabled && (
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginTop: '0.75rem', padding: '0.5rem 0.75rem', background: '#ffffff', borderRadius: '16px', border: '1.5px solid #ede9fe' }}>
