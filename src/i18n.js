...
export const COPY = {
  en: {
    ...
    enterOtp6: 'Enter the 6-digit code sent to your emergency contact number.',
    otpSent: 'OTP sent to',
    verifyAndContinue: 'Verify & Continue',
    otpInvalid: 'Please enter a valid 6-digit code.',
    otpInvalidNumber: 'Invalid phone number. Please check the number and country code.',
    otpTooMany: 'Too many attempts. Please try again later.',
    otpQuotaExceeded: 'SMS quota exceeded. Please try again later.',
  ...
  ta: {
    ...
    enterOtp6: 'உங்கள் அவசர தொடர்பு எண்ணுக்கு அனுப்பப்பட்ட 6 இலக்கக் குறியீட்டை உள்ளிடவும்.',
    otpSent: 'OTP அனுப்பப்பட்டது',
    verifyAndContinue: 'சரிபார்த்து தொடரவும்',
    otpInvalid: 'சரியான 6 இலக்கக் குறியீட்டை உள்ளிடவும்.',
    otpInvalidNumber: 'தவறான தொலைபேசி எண். எண் மற்றும் நாட்டுக் குறியீட்டைச் சரிபார்க்கவும்.',
    otpTooMany: 'அதிக முயற்சிகள். பின்னர் மீண்டும் முயற்சிக்கவும்.',
    otpQuotaExceeded: 'SMS வரம்பு மீறப்பட்டது. பின்னர் மீண்டும் முயற்சிக்கவும்.',
  ...
  hi: {
    ...
    enterOtp6: 'आपके आपातकालीन संपर्क नंबर पर भेजा गया 6 अंकों का कोड दर्ज करें।',
    otpSent: 'OTP भेजा गया',
    verifyAndContinue: 'सत्यापित करें और जारी रखें',
    otpInvalid: 'कृपया एक मान्य 6 अंकों का कोड दर्ज करें।',
    otpInvalidNumber: 'अमान्य फ़ोन नंबर। नंबर और देश कोड जाँचें।',
    otpTooMany: 'बहुत अधिक प्रयास। कृपया बाद में पुनः प्रयास करें।',
    otpQuotaExceeded: 'SMS कोटा समाप्त। कृपया बाद में पुनः प्रयास करें।',
  ...
  ml: {
    ...
    enterOtp6: 'നിങ്ങളുടെ അടിയന്തര ബന്ധ നമ്പറിലേക്ക് അയച്ച 6 അക്ക കോഡ് നൽകുക.',
    otpSent: 'OTP അയച്ചു',
    verifyAndContinue: 'പരിശോധിച്ച് തുടരുക',
    otpInvalid: 'ദയവായി സാധുവായ 6 അക്ക കോഡ് നൽകുക.',
    otpInvalidNumber: 'തെറ്റായ ഫോൺ നമ്പർ. നമ്പറും രാജ്യ കോഡും പരിശോധിക്കുക.',
    otpTooMany: 'വളരെയധികം ശ്രമങ്ങൾ. പിന്നീട് വീണ്ടും ശ്രമിക്കുക.',
    otpQuotaExceeded: 'SMS ക്വോട്ട കഴിഞ്ഞു. പിന്നീട് വീണ്ടും ശ്രമിക്കുക.',
